...
public class C11_NestedIfElse {
    public static void main(String[] args) {
        ...
        if (urunAdedi>10){ //urun sayisi 10dan fazla
            if(kartVarmi=='E' || kartVarmi=='e') System.out.println("%20 indirimli toplam fiyat : " + urunAdedi*listeFiyati*0.8);
            if(kartVarmi=='H' || kartVarmi=='h') System.out.println("%15 indirimli toplam fiyat : " + urunAdedi*listeFiyati*0.85);
            else System.out.println("hatali kart bilgisi");


        } else if (urunAdedi>0) { //urun sayisi 0-10 arasi
            if(kartVarmi=='E' || kartVarmi=='e') System.out.println("%15 indirimli toplam fiyat : " + urunAdedi*listeFiyati*0.85);
            if(kartVarmi=='H' || kartVarmi=='h') System.out.println("%10 indirimli toplam fiyat : " + urunAdedi*listeFiyati*0.9);
            else System.out.println("hatali kart bilgisi");
